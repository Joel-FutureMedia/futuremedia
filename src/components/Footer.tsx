...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-primary text-primary-foreground py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
